...
## Building
KSP Build Tools is setup here, so the only thing you need to do is point it to a KSP install. [Here](https://kspbuildtools.readthedocs.io/en/stable/msbuild/ksp-install.html) is all the info you need.
